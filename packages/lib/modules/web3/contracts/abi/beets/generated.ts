...
/**
 * [__View Contract on Fantom Ftm Scan__](https://ftmscan.com/address/0x310A1f7bd9dDE18CCFD701A796Ecb83CcbedE21A)
 */
export const beetsFtmStakingAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'low', internalType: 'uint256', type: 'uint256', indexed: false },
      {
        name: 'high',
        internalType: 'uint256',
        type: 'uint256',
  ...
  },
  {
    ...
    inputs: [],
    name: 'FTMX',
    outputs: [{ name: '', internalType: 'contract IERC20Burnable', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'poolAmount', internalType: 'uint256', type: 'uint256' },
      { name: 'undelegateAmount', internalType: 'uint256', type: 'uint256' },
  ...
  {
    type: 'function',
    inputs: [{ name: 'amountFTMx', internalType: 'uint256', type: 'uint256' }],
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'ftmAmount', internalType: 'uint256', type: 'uint256' },
      { name: 'toIgnore', internalType: 'bool', type: 'bool' },
    ],
  ...
  {
    type: 'function',
    inputs: [{ name: 'vaultIndex', internalType: 'uint256', type: 'uint256' }],
  ...
  {
    type: 'function',
    inputs: [{ name: 'wrID', internalType: 'uint256', type: 'uint256' }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'amountToUnlock', internalType: 'uint256', type: 'uint256' },
          {
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'low', internalType: 'uint256', type: 'uint256' },
      { name: 'high', internalType: 'uint256', type: 'uint256' },
    ],
  ...
  {
    type: 'function',
    inputs: [{ name: 'desiredValue', internalType: 'bool', type: 'bool' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'newVaultIndex', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'shiftVaultIndex',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'amountFTMx', internalType: 'uint256', type: 'uint256' },
      { name: 'minAmountFTM', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'undelegate',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    inputs: [],
    name: 'validatorPicker',
    outputs: [{ name: '', internalType: 'contract IValidatorPicker', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    inputs: [
      { name: 'wrID', internalType: 'uint256', type: 'uint256' },
      { name: 'bitmaskToSkip', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'withdraw',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    type: 'function',
    inputs: [{ name: 'maturedIndex', internalType: 'uint256', type: 'uint256' }],
 ...
 * [__View Contract on Fantom Ftm Scan__](https://ftmscan.com/address/0x310A1f7bd9dDE18CCFD701A796Ecb83CcbedE21A)
 */
export const beetsFtmStakingAddress = {
  250: '0x310A1f7bd9dDE18CCFD701A796Ecb83CcbedE21A',
} as const

/**
 * [__View Contract on Fantom Ftm Scan__](https://ftmscan.com/address/0x310A1f7bd9dDE18CCFD701A796Ecb83CcbedE21A)
 */
export const beetsFtmStakingConfig = {
  address: beetsFtmStakingAddress,
