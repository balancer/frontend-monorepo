export const magpieRouterV3_1Abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'fromAssetAddress', type: 'address' },
      { indexed: false, internalType: 'address', name: 'toAssetAddress', type: 'address' },
