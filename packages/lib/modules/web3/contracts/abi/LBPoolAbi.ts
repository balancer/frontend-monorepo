export const LBPoolAbi = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'contract IERC20', name: 'projectToken', type: 'address' },
          { internalType: 'contract IERC20', name: 'reserveToken', type: 'address' },
          { internalType: 'uint256', name: 'startTime', type: 'uint256' },
          { internalType: 'uint256', name: 'endTime', type: 'uint256' },
          { internalType: 'bool', name: 'blockProjectTokenSwapsIn', type: 'bool' },
        ],
      ...
      {
        components: [
          { internalType: 'uint256', name: 'projectTokenStartWeight', type: 'uint256' },
          { internalType: 'uint256', name: 'reserveTokenStartWeight', type: 'uint256' },
          { internalType: 'uint256', name: 'projectTokenEndWeight', type: 'uint256' },
          { internalType: 'uint256', name: 'reserveTokenEndWeight', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'reserveTokenAmountOut', type: 'uint256' },
      { internalType: 'uint256', name: 'reserveTokenRealBalance', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'SeedlessLBPInitializationWithNonZeroReserve', type: 'error' },
  {
  ...
  { anonymous: false, inputs: [], name: 'EIP712DomainChanged', type: 'event' },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256[]', name: 'startWeights', type: 'uint256[]' },
