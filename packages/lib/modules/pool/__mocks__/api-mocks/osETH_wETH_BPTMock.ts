...
export const osETH_wETH_BPTMock = {
  ...
  dynamicData: {
    ...
    swapEnabled: true,
    totalLiquidity: '57680364.99',
    totalShares: '17733.371272619553957115',
    fees24h: '11.44',
    surplus24h: '0.00',
    swapFee: '0.0001',
    volume24h: '114381.24',
  ...
  bptPriceRate: '1.015900414439042628',
  poolTokens: [
    {
      id: '0xdacf5fa19b1f720111609043ac67a9818262850c000000000000000000000635-0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
      chain: 'MAINNET',
      ...
      isErc4626: false,
      index: 0,
      balance: '8146.342151738575',
      balanceUSD: '26081899.27695685',
      priceRate: '1.0',
      weight: null,
      hasNestedPool: false,
      isAllowed: true,
    ...
    },
    {
      ...
      balanceUSD: '0',
      priceRate: '1.015900414439042628',
      weight: null,
      hasNestedPool: false,
      isAllowed: true,
      priceRateProvider: null,
    ...
    },
    {
      ...
      isErc4626: false,
      index: 2,
      balance: '9523.519326145337',
      balanceUSD: '31598465.71299066',
