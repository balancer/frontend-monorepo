...
export const b_80BAL_20WETHMock = {
  ...
  dynamicData: {
    ...
    swapEnabled: true,
    totalLiquidity: '57524284.69',
    totalShares: '6658950.264341833804708727',
    fees24h: '4559.02',
    surplus24h: '0.00',
    swapFee: '0.01',
    volume24h: '455902.08',
  ...
  poolTokens: [
    {
      ...
      isErc4626: false,
      index: 0,
      balance: '19104001.458892353',
      balanceUSD: '46040643.51593057',
      priceRate: '1.0',
      weight: '0.8',
      hasNestedPool: false,
      isAllowed: true,
