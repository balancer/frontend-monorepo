...
export const b_50sDAI_50wstETH = {
  ...
  dynamicData: {
    ...
    swapEnabled: true,
    totalLiquidity: '4130119.13',
    totalShares: '62190.760195162303656242',
    fees24h: '1093.86',
    surplus24h: '0.00',
    swapFee: '0.003',
    volume24h: '364619.52',
  ...
  staking: {
    ...
    gauge: {
      ...
      version: 2,
      status: 'PREFERRED',
      workingSupply: '7586.021712770295905367',
      otherGauges: [],
      rewards: [
        {
  ...
  poolTokens: [
    {
      ...
      isErc4626: false,
      index: 0,
      balance: '563.6147132802639',
      balanceUSD: '2051935.178198058',
      priceRate: '1.0',
      weight: '0.5',
      hasNestedPool: false,
      isAllowed: true,
    ...
    },
    {
      ...
      isErc4626: true,
      index: 1,
      balance: '1791537.8929728484',
      balanceUSD: '2078183.955848504',
      priceRate: '1.0',
      weight: '0.5',
      hasNestedPool: false,
      isAllowed: true,
