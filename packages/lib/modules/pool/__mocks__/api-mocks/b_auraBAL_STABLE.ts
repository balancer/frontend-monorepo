...
export const b_auraBAL_STABLE = {
  ...
  staking: {
    ...
    gauge: {
      ...
      version: 1,
      status: 'PREFERRED',
      workingSupply: '431079.884786972686798735',
      otherGauges: [],
      rewards: [
        {
  ...
  poolTokens: [
    {
      ...
      nestedPool: {
        ...
        type: 'WEIGHTED',
        bptPriceRate: '1.0',
        nestedPercentage: '0.01099862724719362',
        nestedShares: '73206.70063717505',
        totalLiquidity: '54896100.34975753',
        totalShares: '6655985.241781357',
        tokens: [
          {
            index: 0,
            address: '0xba100000625a3754423978a60c9317c58a424e3d',
            decimals: 18,
            balance: '210115.6281877322',
            balanceUSD: '483265.944831784',
            symbol: 'BAL',
            weight: '0.8',
            isErc4626: false,
          ...
          },
          {
            ...
            address: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
            decimals: 18,
            balance: '39.3608377500096',
            balanceUSD: '120515.80023973447',
            symbol: 'WETH',
            weight: '0.2',
            isErc4626: false,
            isBufferAllowed: true,
