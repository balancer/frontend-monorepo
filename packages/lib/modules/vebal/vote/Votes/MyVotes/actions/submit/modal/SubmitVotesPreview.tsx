import { VStack, Card, HStack, Text, Divider, Box } from '@chakra-ui/react'
...
export function SubmitVotesPreview({
  ...
  const totalWithOptimized = '175' // fix: (votes) provide real value
      ...
      <HStack alignItems="stretch" spacing="sm" w="full">
        <Card flex="1" variant="subSection">
          ...
          <HStack spacing="xs">
            ...
            <MyIncentivesAprTooltip totalWithOptimized={totalWithOptimized} />
          </HStack>
        </Card>
        <Card flex="1" variant="subSection">
