...
export function MyVotes() {
  const { hasAllVotingPowerTimeLocked, isExpired, lockTooShort, shouldResubmitVotes } = useVotes()
  const { sortedMyVotes, loading: myVotesLoading } = useMyVotes()
            ...
            <Alert status="warning">
              ...
              <HStack alignItems="baseline">
                ...
                <AlertDescription>
                  ...
                  the 'Edit votes' button to resubmit your votes.
                </AlertDescription>
              </HStack>
            </Alert>
          </GridItem>
