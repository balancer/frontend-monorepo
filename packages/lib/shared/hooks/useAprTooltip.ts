...
const maBeetsRewardTooltipText = 'This APR is determined by the maturity of the Relic.'
...
const fuulTooltipText =
  'Fuul is a platform that allows 3rd party Incentive Providers to offer campaigns with additional yield for Liquidity Providers.'
