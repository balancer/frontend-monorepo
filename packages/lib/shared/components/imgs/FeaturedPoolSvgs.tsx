...
function usePoolTextures() {
  ...
  return { marbleTexture, rockTexture }
}

export function FeaturedPool1SVG() {
  const id = useId()
  const { marbleTexture, rockTexture } = usePoolTextures()
  return (
    <svg
    ...
    >
      ...
      <defs>
        <pattern
          height="142"
          id={`marble-texture-1-${id}`}
          patternUnits="userSpaceOnUse"
          width="142"
        >
          <image height="142" href={marbleTexture} width="142" x="0" y="0" />
        </pattern>
        <pattern height="142" id={`rock-texture-1-${id}`} patternUnits="userSpaceOnUse" width="142">
        ...
        <linearGradient
          ...
          y2="33.45"
        >
          <stop stopColor="#3D7598" stopOpacity="0.7" />
          <stop offset="1" stopColor="#BDD6E5" stopOpacity="0.7" />
        </linearGradient>
      </defs>
    </svg>
  )
  ...
  return (
    ...
    >
      <defs>
        <pattern
          height="142"
          id={`marble-texture-2-${id}`}
          patternUnits="userSpaceOnUse"
          width="142"
        >
          <image height="142" href={marbleTexture} width="142" x="0" y="0" />
        </pattern>
        <pattern height="142" id={`rock-texture-2-${id}`} patternUnits="userSpaceOnUse" width="142">
          <image height="142" href={rockTexture} width="142" x="0" y="0" />
        </pattern>
        {/* Top */}
        <linearGradient
  ...
  return (
    ...
    >
      <defs>
        <pattern
          height="142"
          id={`marble-texture-3-${id}`}
          patternUnits="userSpaceOnUse"
          width="142"
        >
          <image height="142" href={marbleTexture} width="142" x="0" y="0" />
        </pattern>
        <pattern height="142" id={`rock-texture-3-${id}`} patternUnits="userSpaceOnUse" width="142">
          <image height="142" href={rockTexture} width="142" x="0" y="0" />
        </pattern>
        <linearGradient
          gradientUnits="userSpaceOnUse"
