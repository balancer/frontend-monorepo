...
import {
  ...
  TransactionStep,
} from '../../components/ReliquaryTransactionStepsSubmit'
    ...
    if (!isLoading) {
      ...
      if (!batchRelayerHasApprovedForAll) {
        steps.unshift({
          ...
          tooltipText:
            'Transacting with all (future) relics requires you to approve the batch relayer.',
        })
      }
  ...
  return (
    <VStack width="full" spacing="4">
      ...
      <Box
        ...
        pb={
          reliquaryJoinQuery.isConfirmed ||
          reliquaryJoinQuery.isFailed ||
          reliquaryJoinQuery.isPending
            ? '0'
            : '4'
        }
      >
