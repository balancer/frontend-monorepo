      ...
      <Prose>
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              ...
              mobile interfaces. These Terms apply to you (“You” or “you”) as a user of our Site
              including all the products, services, tools and information, without limitation, made
            ...
            <p>
              ...
              the Terms. BeethovenX DAO in its sole discretion reserves the right to make changes to
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              ...
              smart contracts that can be accessed via the BeethovenX DAO user interface including,
              without limitation, the smart contracts for Beets Pools. For more information about
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <p>
              ...
              agreement (the “Agreement”), available{' '}
              <ChakraLink
                color="white"
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <ul>
              ...
              <li>
                Export, reexport, or transfer, directly or indirectly, any BeethovenX DAO technology
              ...
              <li>
                ...
                redirect or inhibit other users from fully enjoying the Site or the Beets Protocol,
                or that could damage, disable, overburden, or impair the functioning of the Site or
                the Beets Protocol in any manner;
              </li>
              <li>
                Attempt to circumvent or disable any content filtering techniques or security
                measures that BeethovenX DAO employs on the Site, or attempt to access any service
                or area of the Site that you are not authorized to access;
              </li>
              <li>
        ...
        <FadeInOnView>
          <div className="subsection">
            ...
            <ul>
              <li>
                Losses while digital assets are being supplied to the Beets Protocol and losses due
                to the fluctuation of prices of tokens in a swapping pair or liquidity pool. Prices
                of digital currencies, tokens and/or other digital assets fluctuate day by day or
                even minute by minute. The value of your available balance could surge or drop
                suddenly. Please note that there is a possibility that the price of tokens could
                decrease to zero. Prices of tokens are prone to significant fluctuations, for
            ...
            <ol>
              ...
              <li>
                that you expressly waive and release BeethovenX DAO from any and all liability,
                claims, causes of action, responsibility or damages arising from or in any way
          ...
          <div className="subsection">
            ...
            <p>
              <em className="font-semibold">
                ...
                constitutes an agreement to limit the liability of BeethovenX DAO and our officers,
          ...
          <div className="subsection">
            ...
            <p>
              <em className="font-semibold">
                ...
                claims. You agree that, by entering into this agreement, you and BeethovenX DAO are
