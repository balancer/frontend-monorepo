        ...
        <div className="pb-4">
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <ul>
                <li>
                  Beets does not typically request, collect or use personal information. With the
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <ul>
                <li>Ensure proper functioning of Beets and the UI;</li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                described herein, in the normal course of Beets business. However, when Beets has
                access to personal information, such as your wallet and certain IP addresses, it may
                share that information in the following circumstances or as otherwise described in
                this policy:
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  of Beets, the Beets ecosystem, the public, or others.
                </li>
                <li>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                Therefore, we and our service providers may transfer your personal information to,
                or store or access it in, jurisdictions that may not provide levels of data
                protection that are equivalent to those of your home jurisdiction. We will take
                steps to ensure that your personal information receives an adequate level of
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                Beets does not “sell” personal information to advertise our products to you or
                otherwise.
              </p>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                as a wallet address and certain IP addresses, it will do so in reliance on the
              ...
              <p>
                ...
                request that we restrict, certain processing. Beets does not typically hold or store
                such personal data.
              </p>
            </div>
          </FadeInOnView>
