...
import { VoteMarketData } from '@repo/lib/shared/services/votemarket/votemarket.types'
...
function incentivesWithAmount(amount: number, maxTokensPerVote: number): VoteMarketData {
  return {
    totalValue: 0,
    maxValuePerVote: -1,
    valuePerVote: -1,
