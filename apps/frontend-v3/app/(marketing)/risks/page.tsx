                ...
                <div className="subsection">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      portion of validators, the update could be effectively stalled or blocked.
                    </p>
                    <p>The risks of using Oracles to supply exchange rates include:
                    </p>
                    <ul>
                      <li>
                ...
                <div>
                    ...
                    <ul>
                      <li>
                        ...
                        economic outcomes. Rapidly changing market conditions and volatility can severely 
                        affect pool performance and backward-looking metrics can create a false sense 
                        of predictability.
                      </li>
                      <li>
                        APR Calculation Vulnerabilities: Reported Annual Percentage Rates (APR) frequently 
                        do not reflect true economic return. APR does not account for losses resulting 
                        from the market making strategy.  It is simply a measure of fees earned over TVL on
                        a 24h timeframe.
                      </li>
                    </ul>
                    </p>
              ...
              <FadeInOnView>
                <div className="subsection">
                  ...
                  <p>
                      ...
                      not an accurate reflection of the real return. Learn more about
                      oracle and path depedency risks in the{' '}
