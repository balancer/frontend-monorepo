            ...
            <FadeInOnView>
              ...
              <FadeInOnView>
                ...
                <div className="subsection">
                  ...
                  <p>
                    Basically, when MEV extraction occurs within one of these pools, a portion of the
                    profit gained by the searcher (MEV extractor) is automatically collected as a fee.
                    This fee is then distributed to the LPs who have provided liquidity to that pool. 
                    The intention is to compensate LPs for the potential negative impact of MEV on their
                    returns and to create a more equitable distribution of value generated within the pool.
                  </p>
                  <p>
                   This hook introduces a novel mechanism that may impact the risk profile of a pool. Please 
                    also refer to 
                    <Link href="risks#hooks-risk">
                      <span>Hooks</span>
                    </Link>{' '}
                  ...
                  <ul>
                    <li>
                      ...
                      several factors, including but not limited to: pool imbalances, market volatility,
                      and the specific configuration of the taxation parameters, like the multiplier 
                      and minimum threshold. The amount of MEV extracted and the resulting fee will vary
                      depending on market conditions and the activity of searchers (MEV extractors).
                    </li>
                    <li>
                    ...
                    <li>
                      To ensure precise and fair allocation, transactions subject to MEV Capture hook
                      are restricted to single-hop trades. This is enforced by the router and allows us to 
                      definitively identify which pool should receive the collected fees.
                    </li>
                  </ul>
                </div>
              </FadeInOnView>
