  ...
  return (
    <FadeInOnView>
      <VStack margin="lg" padding="lg">
        ...
        <Link asChild>
          <NextLink href="pools/sepolia/v3/0x86fde41ff01b35846eb2f27868fb2938addd44c4">
            Sepolia WEIGHTED (Balancer 50 DAI 50 USDC)
          </NextLink>
        </Link>
        <Link asChild>
          <NextLink href="/pools/sepolia/v3/0xb1769fee9845e2762539c9d4b6a3793388152930">
            Sepolia Weighted BOOSTED pool (Balancer 50 WETH 50 stataUSDC)
          </NextLink>
        </Link>
        <Link asChild>
          <NextLink href="/pools/sepolia/v3/0x693cc6a39bbf35464f53d6a5dbf7d6c2fa93741c">
            Sepolia reference NESTED boosted pool (Balancer 50 bbaUSD 50 WETH)
          </NextLink>
        </Link>
        <Link asChild>
          <NextLink href="/pools/sepolia/v3/0xc832a37c8252117604f1329b4a7fed7076880b27">
            Sepolia reference STABLE NESTED pool (Balancer DAI/USDC/USDT)
          </NextLink>
        </Link>
        <Link asChild>
          <NextLink href="/pools/sepolia/v3/0x59fa488dda749cdd41772bb068bb23ee955a6d7a">
