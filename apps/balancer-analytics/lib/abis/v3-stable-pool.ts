/**
 * V3 StablePool — events emitted by the pool contract itself.
 *
 * Filter via `address = pool` (no indexed pool argument on these — they're
 * scoped to the emitting contract).
 *
 * Amp updates are ramps: `AmpUpdateStarted` carries the full schedule
 * (start/end value + start/end time). `AmpUpdateStopped` truncates an
 * in-flight ramp. The Stable inspector renders the ramp as a `markArea`
 * between the two events on the timeline.
 */

export const v3StablePoolEventsAbi = [{
    "inputs": [{
        "components": [{
            "internalType": "string",
            "name": "name",
    ...
    "inputs": [],
    "name": "MaxImbalanceRatioExceeded",
    "type": "error"
}, {
    ...
    "outputs": [{
        "components": [{
            ...
            "name": "startValue",
            "type": "uint64"
        }, {"internalType": "uint64", "name": "endValue", "type": "uint64"}, {
            "internalType": "uint32",
            "name": "startTime",
            "type": "uint32"
    ...
    "inputs": [], "name": "getStablePoolDynamicData", "outputs": [{
        "components": [{
            "internalType": "uint256[]",
            "name": "balancesLiveScaled18",
            "type": "uint256[]"
            ...
            "name": "startValue",
            "type": "uint256"
        }, {"internalType": "uint256", "name": "endValue", "type": "uint256"}, {
            "internalType": "uint32",
            "name": "startTime",
            "type": "uint32"
        }, {"internalType": "uint32", "name": "endTime", "type": "uint32"}, {
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "userData",
            "type": "bytes"
        }], "internalType": "struct PoolSwapParams", "name": "request", "type": "tuple"
    }],
    "name": "onSwap",
    ...
    "inputs": [{"internalType": "uint256", "name": "rawEndValue", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "endTime",
        "type": "uint256"
    }], "name": "startAmplificationParameterUpdate", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
