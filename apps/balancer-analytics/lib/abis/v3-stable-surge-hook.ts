/**
 * V3 StableSurge hook — parameter-change events.
 *
 * The surge hook contract is shared across all pools using it; events carry
 * `pool` as an indexed argument so the per-pool filter pattern from the
 * Vault applies here too.
 *
 * Phase A skeleton — event signatures are best-effort against
 * `balancer/balancer-v3-monorepo`'s StableSurgeHook. Verify before Phase C
 * wiring; the exact arg names may shift.
 */

export const v3StableSurgeHookEventsAbi = [{
    "inputs": [{
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "userData",
            "type": "bytes"
        }], "internalType": "struct PoolSwapParams", "name": "params", "type": "tuple"
    ...
    "inputs": [{"internalType": "address", "name": "", "type": "address"}, {
        ...
        "name": "",
        "type": "uint256"
    }, {"internalType": "uint256[]", "name": "amountsOutScaled18", "type": "uint256[]"}, {
        "internalType": "uint256[]",
        "name": "amountsOutRaw",
        "type": "uint256[]"
    }, {"internalType": "uint256[]", "name": "balancesScaled18", "type": "uint256[]"}, {
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "userData",
            "type": "bytes"
        }], "internalType": "struct AfterSwapParams", "name": "", "type": "tuple"
    }],
    "name": "onAfterSwap",
    "outputs": [{"internalType": "bool", "name": "", "type": "bool"}, {
        "internalType": "uint256",
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "userData",
            "type": "bytes"
        }], "internalType": "struct PoolSwapParams", "name": "", "type": "tuple"
    ...
    "inputs": [{"internalType": "address", "name": "pool", "type": "address"}, {
        ...
        "type": "uint256"
    }], "name": "setMaxSurgeFeePercentage", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "address", "name": "pool", "type": "address"}, {
        "internalType": "uint256",
        "name": "newSurgeThresholdPercentage",
        "type": "uint256"
    }], "name": "setSurgeThresholdPercentage", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    "name": "version",
