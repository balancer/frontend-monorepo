/**
 * V3 Vault — parameter-change event ABIs (decode-only).
 *
 * Vault address is CREATE2 and identical on every chain:
 *   0xbA1333333333a1BA1108E8412f11850A5C319bA9
 *
 * All events are emitted by the Vault with `pool` as an indexed first
 * argument, so a single `eth_getLogs` filtered by `topics[1] = pool` covers
 * every event for a given pool in one call.
 *
 * Event signatures track `balancer/balancer-v3-monorepo`'s IVaultEvents
 * interface — verify against the deployed Vault ABI before Phase B wiring.
 */

export const V3_VAULT_ADDRESS = '0xbA1333333333a1BA1108E8412f11850A5C319bA9' as const

export const v3VaultEventsAbi = [
    {
        "inputs": [{
            ...
            "name": "authorizer",
            "type": "address"
        }, {"internalType": "contract IProtocolFeeController", "name": "protocolFeeController", "type": "address"}],
        ...
        "inputs": [{
            ...
            "name": "maxAmountIn",
            "type": "uint256"
        }], "name": "AmountInAboveMax", "type": "error"
    }, {
        "inputs": [{
            "internalType": "contract IERC20",
            "name": "tokenOut",
            ...
            "name": "minAmountOut",
            "type": "uint256"
        }], "name": "AmountOutBelowMin", "type": "error"
        ...
        "inputs": [{"internalType": "uint256", "name": "amountIn", "type": "uint256"}, {
            ...
            "name": "maxAmountIn",
            "type": "uint256"
        }], "name": "BptAmountInAboveMax", "type": "error"
    }, {
        "inputs": [{"internalType": "uint256", "name": "amountOut", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "minAmountOut",
            "type": "uint256"
        }], "name": "BptAmountOutBelowMin", "type": "error"
    }, {
        "inputs": [{"internalType": "contract IERC4626", "name": "wrappedToken", "type": "address"}],
        ...
        "inputs": [{
            ...
            "name": "maxAmountIn",
            "type": "uint256"
        }], "name": "HookAdjustedAmountInAboveMax", "type": "error"
    }, {
        "inputs": [{
            "internalType": "contract IERC20",
            "name": "tokenOut",
            ...
            "name": "minAmountOut",
            "type": "uint256"
        }], "name": "HookAdjustedAmountOutBelowMin", "type": "error"
    }, {
        "inputs": [{"internalType": "uint256", "name": "amount", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "limit",
            "type": "uint256"
        }], "name": "HookAdjustedSwapLimit", "type": "error"
    }, {
        "inputs": [{
            "internalType": "address",
            ...
            "name": "poolFactory",
            "type": "address"
        }], "name": "HookRegistrationFailed", "type": "error"
        ...
        "inputs": [{
            ...
            "name": "wrappedToken",
            "type": "address"
        }], "name": "InvalidUnderlyingToken", "type": "error"
    }, {
        "inputs": [{"internalType": "uint256", "name": "invariantRatio", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "maxInvariantRatio",
            "type": "uint256"
        }], "name": "InvariantRatioAboveMax", "type": "error"
    }, {
        "inputs": [{"internalType": "uint256", "name": "invariantRatio", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "minInvariantRatio",
            "type": "uint256"
        }], "name": "InvariantRatioBelowMin", "type": "error"
    }, {
        "inputs": [{"internalType": "uint256", "name": "issuedShares", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "minIssuedShares",
            "type": "uint256"
        }], "name": "IssuedSharesBelowMin", "type": "error"
        ...
        "inputs": [{
            ...
            "type": "uint256"
        }, {"internalType": "uint256", "name": "actualUnderlyingAmount", "type": "uint256"}],
        ...
        "inputs": [{
            ...
            "name": "wrappedToken",
            "type": "address"
        }, {"internalType": "uint256", "name": "expectedWrappedAmount", "type": "uint256"}, {
            "internalType": "uint256",
            "name": "actualWrappedAmount",
            "type": "uint256"
        }], "name": "NotEnoughWrapped", "type": "error"
        ...
        "inputs": [{
            ...
            "name": "wrappedToken",
            "type": "address"
        }], "name": "WrapAmountTooSmall", "type": "error"
    }, {
        "inputs": [],
        ...
        "inputs": [{"indexed": true, "internalType": "address", "name": "pool", "type": "address"}, {
            ...
            "components": [{
                ...
                "name": "poolCreator",
                "type": "address"
            }], "indexed": false, "internalType": "struct PoolRoleAccounts", "name": "roleAccounts", "type": "tuple"
        }, {
            "components": [{
                "internalType": "bool",
        ...
        "inputs": [{
            ...
            "type": "uint256"
        }, {"indexed": false, "internalType": "bytes32", "name": "bufferBalances", "type": "bytes32"}],
        "name": "Unwrap",
        "type": "event"
    }, {
        "anonymous": false,
        "inputs": [{"indexed": true, "internalType": "address", "name": "pool", "type": "address"}, {
            ...
            "name": "eventKey",
            "type": "bytes32"
        }, {"indexed": false, "internalType": "bytes", "name": "eventData", "type": "bytes"}],
        "name": "VaultAuxiliary",
        "type": "event"
    }, {
        "anonymous": false,
        ...
        "inputs": [{
            "components": [{
                ...
                "name": "limitRaw",
                "type": "uint256"
            }], "internalType": "struct BufferWrapOrUnwrapParams", "name": "params", "type": "tuple"
        }],
        ...
        "inputs": [{
            "components": [{
                ...
                "name": "userData",
                "type": "bytes"
            }], "internalType": "struct VaultSwapParams", "name": "vaultSwapParams", "type": "tuple"
        }],
        "name": "swap",
        "outputs": [{
            "internalType": "uint256",
