/**
 * V3 WeightedPool — events emitted by the pool contract itself.
 *
 * Standard WeightedPool has immutable weights, so no param-change events.
 * This file exists so the type-dispatch surface stays uniform across pool
 * types (Phase C inspector wiring), and so weight-mutable variants (Managed
 * Weighted, LBP) can add their event ABIs here without restructuring.
 */

export const v3WeightedPoolEventsAbi = [{
    "inputs": [{
        "components": [{
            "internalType": "string",
            "name": "name",
            ...
            "name": "version",
            "type": "string"
        }, {"internalType": "uint256[]", "name": "minTokenBalances", "type": "uint256[]"}],
    ...
    "inputs": [{
        ...
        "name": "sender",
        "type": "address"
    }], "name": "SenderIsNotVault", "type": "error"
}, {
    ...
    "outputs": [{"internalType": "uint256[]", "name": "minTokenBalances", "type": "uint256[]"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [],
    ...
    "outputs": [{
        "components": [{
            ...
            "type": "bool"
        }], "internalType": "struct WeightedPoolDynamicData", "name": "data", "type": "tuple"
    }],
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "name": "onSwap",
    "outputs": [{"internalType": "uint256", "name": "calculatedAmountScaled18", "type": "uint256"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [{"internalType": "address", "name": "owner", "type": "address"}, {
