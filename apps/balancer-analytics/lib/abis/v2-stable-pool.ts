/**
 * V2 StablePool / ComposableStablePool — amp factor ramp events.
 *
 * Same shape as V3 StablePool's AmpUpdate events. Filter via `address = pool`.
 */

export const v2StablePoolEventsAbi = [{
    "inputs": [{
        "components": [{
            ...
            "name": "version",
            "type": "string"
        }], "internalType": "struct ComposableStablePool.NewPoolParams", "name": "params", "type": "tuple"
    ...
    "anonymous": false,
    "inputs": [{"indexed": true, "internalType": "uint256", "name": "feeType", "type": "uint256"}, {
        "indexed": false,
        "internalType": "uint256",
    ...
    "anonymous": false,
    "inputs": [{"indexed": true, "internalType": "uint256", "name": "tokenIndex", "type": "uint256"}, {
        "indexed": false,
        "internalType": "uint256",
        "name": "rate",
        "type": "uint256"
    ...
    "name": "queryExit",
    "outputs": [{"internalType": "uint256", "name": "bptIn", "type": "uint256"}, {
        "internalType": "uint256[]",
        "name": "amountsOut",
        "type": "uint256[]"
    }],
    ...
    "name": "queryJoin",
    "outputs": [{"internalType": "uint256", "name": "bptOut", "type": "uint256"}, {
        "internalType": "uint256[]",
        "name": "amountsIn",
        "type": "uint256[]"
    }],
    ...
    "inputs": [{"internalType": "contract IERC20", "name": "token", "type": "address"}, {
        ...
        "name": "poolConfig",
        "type": "bytes"
    }], "name": "setAssetManagerPoolConfig", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    ...
    "inputs": [{"internalType": "contract IERC20", "name": "token", "type": "address"}, {
        ...
        "name": "duration",
        "type": "uint256"
    }], "name": "setTokenRateCacheDuration", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
