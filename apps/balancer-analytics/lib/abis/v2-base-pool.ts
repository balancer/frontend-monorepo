/**
 * V2 base pool — parameter-change events common to all V2 pool types.
 *
 * Unlike V3, V2 pools emit param events from the pool contract directly
 * (the V2 Vault is parameter-agnostic and only emits Swap / PoolBalanceChanged).
 * Filter via `address = pool`.
 */

export const V2_VAULT_ADDRESS = '0xBA12222222228d8Ba445958a75a0704d566BF2C8' as const

export const v2BasePoolEventsAbi = [{
    "inputs": [{
        "components": [{"internalType": "string", "name": "name", "type": "string"}, {
            ...
            "type": "uint256"
        }], "internalType": "struct WeightedPool.NewPoolParams", "name": "params", "type": "tuple"
    }, {
