...
const MAINNET: Record<string, MainnetLabel> = {
  ...
  '0x0000000000001ff3684f28c67538d4d072c22734': {
    id: '0x',
    name: 'zeroex: AllowanceHolder',
    category: 'aggregator',
  },
  '0x07e594aa718bb872b526e93eed830a8d2a6a1071': {
    id: '0x',
    name: 'zeroex: MainnetSettler',
    category: 'aggregator',
  },
  '0xdef1c0ded9bec7f1a1670819833240f027b25eff': {
    id: '0x',
    name: 'zeroex: ExchangeProxy',
    category: 'aggregator',
  },
  '0xe66b31678d6c16e9ebf358268a790b763c133750': {
    id: '0x',
    name: 'zeroex: ZeroExProxy',
    category: 'aggregator',
  },

  '0x111111125421ca6dc452d289314280a0f8842a65': {
    id: '1inch',
    name: 'oneinch: AggregationRouterV6',
    category: 'aggregator',
  },
  '0x11111112542d85b3ef69ae05771c2dccff4faa26': {
    id: '1inch',
    name: 'oneinch: AggregationRouterV3',
    category: 'aggregator',
  },
  '0x1111111254eeb25477b68fb85ed929f73a960582': {
    id: '1inch',
    name: 'oneinch: AggregationRouterV5',
    category: 'aggregator',
  },
  '0x1111111254fb6c44bac0bed2854e76f90643097d': {
    id: '1inch',
    name: 'oneinch: AggregationRouterV4',
    category: 'aggregator',
  },
  '0xa88800cd213da5ae406ce248380802bd53b47647': {
    id: '1inch',
    name: 'oneinch: Settlement',
    category: 'aggregator',
  },
  '0xb01f8f528702d411d24c9bb8cc0e2fff779ec013': {
    id: '1inch',
    name: 'oneinch: LeftoverExchangerV1',
    category: 'aggregator',
  },
  '0xdd9f24efc84d93deef3c8745c837ab63e80abd27': {
    id: '1inch',
    name: 'oneinch: GovLeftoverExchanger',
    category: 'aggregator',
  },

  '0x00000000fdac7708d0d360bddc1bc7d097f47439': {
    id: 'paraswap',
    name: 'paraswap: AugustusV6',
    category: 'aggregator',
  },
  '0x000db803a70511e09da650d4c0506d0000100000': {
    id: 'paraswap',
    name: 'paraswap: AugustusV6_1',
    category: 'aggregator',
  },
  '0x6a000f20005980200259b80c5102003040001068': {
    id: 'paraswap',
    name: 'paraswap: AugustusV6_2',
    category: 'aggregator',
  },
  '0x135896de8421be2ec868e0b811006171d9df802a': {
    id: 'paraswap',
    name: 'paraswap: LiquiditySwapAdapter',
    category: 'aggregator',
  },
  '0x80aca0c645fedabaa20fd2bf0daf57885a309fe6': {
    id: 'paraswap',
    name: 'paraswap: RepayAdapter',
    category: 'aggregator',
  },
  '0xdef171fe48cf0115b1d80b88dc8eab59176fee57': {
    id: 'paraswap',
    name: 'paraswap: AugustusSwapper6.0',
    category: 'aggregator',
  },

  '0x21b9f852534fb9ddc3a0a7b24f067b50d8ac9a99': {
    id: 'dodo',
    name: 'dodo: DODOFeeRouteProxy',
    category: 'aggregator',
  },
  ...
  '0x663dc15d3c1ac63ff12e45ab68fea3f0a883c251': {
    id: 'debridge',
    name: 'debridge: DeSwapSender',
    category: 'aggregator',
  },
  '0xe7351fd770a37282b91d153ee690b63579d6dd7f': {
    id: 'debridge',
    name: 'debridge: DlnDestination',
    category: 'aggregator',
  },
  ...
  '0xb300000b72deaeb607a12d5f54773d1c19c7028d': {
    id: 'binance',
    name: 'Binance DEX Aggregator',
    category: 'aggregator',
  },
  '0xce16f69375520ab01377ce7b88f5ba8c48f8d666': {
    id: 'squid',
    name: 'squid_router: SquidRouter',
    category: 'aggregator',
  },
  '0x00000000009726632680fb29d3f7a9734e3010e2': {
    id: 'rainbow',
    name: 'rainbow_swap_aggregator',
    category: 'aggregator',
  },
  ...
  '0x000000000035b5e5ad9019092c665357240f594e': {
    id: 'mev_bot',
    name: 'MEV bot 0x0000…594E',
    category: 'mev_bot',
  },
  '0x00c21ca82d94dade0d5d1ed420a4728f58427d21': {
    id: 'mev_bot',
    name: 'MEV bot 0x00C2…7D21',
    category: 'mev_bot',
  },
  '0x01fdc48ba0903bb1ae7c517c9287d88ea236f8e1': {
    id: 'mev_bot',
    name: 'MEV bot 0x01FD…F8E1',
    category: 'mev_bot',
  },
  '0x1f2f10d1c40777ae1da742455c65828ff36df387': {
    id: 'mev_bot',
    name: 'jaredfromsubway #2',
    category: 'mev_bot',
  },
  '0xa0f1c3ad83e07d97b5e7030e177718be175275ea': {
    id: 'mev_bot',
    name: 'MEV-funded EOA 0xA0F1…75EA',
    category: 'mev_bot',
  },
  '0xd8349e874934593c85eafa8e534b495d80848e41': {
    id: 'mev_bot',
    name: 'MEV-interacting EOA 0xD834…8E41',
    category: 'mev_bot',
  },
  '0xe00456d3af6e9b8715a9c29c88c1932983e064c1': {
    id: 'mev_bot',
    name: 'MEV-funded EOA 0xE004…64C1',
    category: 'mev_bot',
  },
  ...
  '0x654fae4aa229d104cabead47e56703f58b174be4': {
    id: 'mev_bot',
    name: 'MEV bot 0x654f…4be4',
    category: 'mev_bot',
  },
  '0xae2fc483527b8ef99eb5d9b44875f005ba1fae13': {
    id: 'mev_bot',
    name: 'MEV bot 0xae2f…fae13',
    category: 'mev_bot',
  },

  // MEV bot identified on the rETH/Aave WETH pool ($657k across 9 swaps).
  '0xa0b1c5f88d9a1acdd4f7ff869e947bfd54c07c61': {
    id: 'mev_bot',
    name: 'MEV bot 0xa0b1…7c61',
    category: 'mev_bot',
  },
  ...
  '0xbee018a99073a0d838d2412add382db3af711005': {
    id: 'mm',
    name: 'Market maker 0xbee0…1005',
    category: 'market_maker',
  },
  '0xbee4b69f6821ee7196182788392ff188bac99011': {
    id: 'mm',
    name: 'Market maker 0xbee4…9011',
    category: 'market_maker',
  },
  ...
  '0x7b49bc3ebbdf7322f31c6449320382bbec3be1b6': {
    id: '1inch',
    name: 'oneinch: router 0x7b49…e1b6',
    category: 'aggregator',
  },
  '0x70e59f9c304e4d5096bd408b571e2dcd99c3120b': {
    id: '1inch',
    name: 'oneinch: router 0x70e5…120b',
    category: 'aggregator',
  },
  '0xe99bd1c2dd70cd58e5efd47887991700e7318ce2': {
    id: '1inch',
    name: 'oneinch: router 0xe99b…8ce2',
    category: 'aggregator',
  },
}
...
const MONAD: Record<string, MonadLabel> = {
  ...
  '0x22c6a8b73641e9a1e8066a01c71c388e52230659': {
    id: 'mev_bot',
    name: 'MEV bot / flashbot 0x22c6…0659',
    category: 'mev_bot',
  },
  // Across protocol bridge — heavy interaction with Across infra.
  '0xcad97616f91872c02ba3553db315db4015cbe850': {
    id: 'across',
    name: 'Across bridge 0xcad9…e850',
    category: 'bridge',
  },
  // LFJ (Trader Joe) — LB Router + Joe Aggregator transactions on Monad.
  '0x086ff8a909b3082b07541bb50a41a61168e26538': {
    id: 'lfj',
    name: 'LFJ aggregator 0x086f…6538',
    category: 'aggregator',
  },
}
